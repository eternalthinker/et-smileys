//Code and Smileys by et @ http://eternalthinker.blogspot.com/ ... Ask me if you want to reuse the smileys. 
...
function addSmiley() {
    ...
    for (i = 0; i < d.length; i++) {
    	...
    	function(symbol) { return ' <img src="' + smileyMap[symbol] + '" style="border:0; margin:0; padding:0;" id="new" />' });  
